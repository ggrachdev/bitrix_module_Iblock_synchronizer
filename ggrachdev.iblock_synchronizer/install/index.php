...
class ggrachdev_iblock_synchronizer extends CModule {
    ...
    function __construct() {
        ...
        $this->MODULE_DESCRIPTION = GetMessage('GGRACHDEV_IBLOCK_SYNCHRONIZER_DESC');
        $this->MODULE_VERSION = $arModuleVersion['VERSION'];
        $this->MODULE_VERSION_DATE = $arModuleVersion['VERSION_DATE'];
        $this->PARTNER_NAME = GetMessage("GGRACHDEV_IBLOCK_SYNCHRONIZER_OPTIONS_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("GGRACHDEV_IBLOCK_SYNCHRONIZER_OPTIONS_PARTNER_URI");
    }
